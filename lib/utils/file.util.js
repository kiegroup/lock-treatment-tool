...
async function readLineSync(filePath, processLineFn) {
  return new Promise((resolve, reject) => {
    readline.eachLine(filePath, (line, last, callback) => {
      processLineFn(line)
...
module.exports.checkOutputFolderExistance = checkOutputFolderExistance;
